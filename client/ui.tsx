...
export function stripHtml(text: string): string {
  return text
    ...
    // Numeric entities generically — was only matching the exact 2-digit &#39; before, so the equally-valid
    // zero-padded &#039; (observed live: literal "&#039;" showing up raw, e.g. "group&#039;s document")
    // slipped through untouched. Same fix as server/pronote.ts's copy of this function.
