...
Memory + tasks are saved to **Supabase** keyed by your Google email, so they survive restarts/redeploys
and follow your account. Reuses Weave's existing Supabase project (`VITE_SUPABASE_URL` +
